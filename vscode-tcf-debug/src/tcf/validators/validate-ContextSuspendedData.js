...
let missing0;
if(((((data.data === undefined) && (missing0 = "data")) || ((data.id === undefined) && (missing0 = "id"))) || ((data.pc === undefined) && (missing0 = "pc"))) || ((data.reason === undefined) && (missing0 = "reason"))){
...
validate20.errors = [{instancePath:instancePath+"/reason",schemaPath:"#/properties/reason/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
